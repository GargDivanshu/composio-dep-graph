...
- Profiled build time: about 1.9s locally with inference at about 1.4s
...
Use the visualization in focused mode to inspect specific dependency neighborhoods. Use filtered or all-edge mode only when you need a broader diagnostic view.
